        ...
        <div className="bootcamp-features-what-you-get">
          <div className="bfc-header">
            ...
            <p className="bootcamp-features-lead">
              <b>Preparation is never shaped by study material alone.</b> It is
              shaped by the environment you sit in, the people who guide you,
              the food you eat, the discipline around you, and the emotional
              support that keeps you going on difficult days. That is what makes
              the<b> CoreBTR Bootcamp</b> at{" "}
              <b>Vidya Jeevan Experience Centre</b>
              different. Vidya Jeevan is not just a venue. It is an ecosystem
              created from the{" "}
              <b>
                journey of thousands of students, built on the belief that
                students need more than classes.
              </b>
            </p>
          </div>
