  ...
  return (
    <section className={`bch bch--${phase}`} aria-label="Bootcamp Hero">
      ...
      <div className="bch__intro-name">
        <span className="bch__intro-sub">NEET PG BOOTCAMP</span>
      ...
      <div className="bch__right">
        ...
        <span className="bch__r-place">at Vidya Jeevan,<br />Greater Noida</span>
        <span className="bch__r-cta">NEW BATCH STARTED</span>
      </div>

      {/* ── LEFT: NEET PG BOOTCAMP big — expand only ── */}
      <div className="bch__left-title">
        <span className="bch__left-title-text">NEET PG<br />BOOTCAMP</span>
      </div>
