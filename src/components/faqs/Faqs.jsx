  ...
  return (
    <div className="faq-container">
      <div className="faq-header">
        ...
        <p>
          Browse category-wise help to find answers to your questions about
          CoreBTR programs, plans, and more.
        </p>
      </div>
