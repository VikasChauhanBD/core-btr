      ...
      <div className="offline-details-wrapper">
        <div className="offline-details-header">
          <h2 className="offline-details-subtitle">
            BTR NEET PG Offline Cities 2026
          </h2>
        ...
        <div className="offline-details-cities-section">
          <h3 className="offline-details-cities-title">
            Upcoming BTR NEET PG Offline Cities
          </h3>
          ...
          <div className="offline-details-cities-grid">
            {cities.map((city, i) => (
              <div className="offline-details-city-card" key={i}>
                <div
                  className={`offline-details-city-circle ${
                ...
                {/* Show CTA only if available */}
                {city.cta && (
                  <NavLink
                    to={city.url || "#"}
                    className="offline-details-city-cta"
                  >
                    {city.cta}
                  </NavLink>
                )}
          ...
          <div className="offline-details-cities-cta">
            <NavLink to="#">Registration Will Start Soon</NavLink>
          </div>
        </div>
      </div>
    </div>
